...
from src.stmpro.files import files
from src.stmpro.data.topography import Topography
from src.stmpro.gui.result_window import ResultWindow, SpectroscopyWindow, SpectroscopyMapWindow, CombinedSpectroscopyMapWindow, TopographyWindow
from src.stmpro.gui.filter_window import FilterWindow
from src.stmpro.gui.profile_window import ProfileWindow
from src.stmpro.gui.histogram_window import HistogramWindow
from src.stmpro.gui.fourier_window import FourierWindow
from src.stmpro.gui.scale_window import ScaleWindow
from src.stmpro.gui.export_window import ExportWindow
...
class MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/open_mtrx.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/open_xyz.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/undo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/redo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/export.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/set_zero.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/profile.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/level.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/level_linewise.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/filter.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/fft.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/rotate_clockwise.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/rotate_anticlockwise.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/vertical_mirror.png")), QtGui.QIcon.Normal,
                       QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/horizontal_mirror.png")), QtGui.QIcon.Normal,
                       QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("../../resources/icons/scale.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        # Profiles tools
        self.label3 = QtWidgets.QLabel(self.centralwidget, text='Profiles')
        self.vertical_layout.addWidget(self.label3)

        self.grid_layout3 = QtWidgets.QGridLayout(self.centralwidget)
        self.grid_layout3.setObjectName("Curves")
        self.vertical_layout.addLayout(self.grid_layout3)

        self.measure_button = QtWidgets.QPushButton(self.centralwidget)
        self.measure_button.setObjectName("Measure_button")
        self.measure_button.setMinimumSize(QtCore.QSize(button_size, button_size))
        self.measure_button.setMaximumSize(QtCore.QSize(button_size, button_size))
        self.measure_button.setText("")
        self.measure_button.setCheckable(True)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.measure_button.setIcon(icon)
        self.measure_button.setIconSize(QtCore.QSize(button_size, button_size))
        self.grid_layout3.addWidget(self.measure_button, 0, 0, 1, 1)

        self.set_zero_to_min_button = QtWidgets.QPushButton(self.centralwidget)
        self.set_zero_to_min_button.setObjectName("set_zero_to_min_button")
        self.set_zero_to_min_button.setMinimumSize(QtCore.QSize(button_size, button_size))
        self.set_zero_to_min_button.setMaximumSize(QtCore.QSize(button_size, button_size))
        self.set_zero_to_min_button.setText("")
        self.set_zero_to_min_button.setCheckable(True)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.set_zero_to_min_button.setIcon(icon)
        self.set_zero_to_min_button.setIconSize(QtCore.QSize(button_size, button_size))
        self.grid_layout3.addWidget(self.set_zero_to_min_button, 0, 1, 1, 1)

        self.set_zero_to_avg_button = QtWidgets.QPushButton(self.centralwidget)
        self.set_zero_to_avg_button.setObjectName("set_zero_to_avg_button")
        self.set_zero_to_avg_button.setMinimumSize(QtCore.QSize(button_size, button_size))
        self.set_zero_to_avg_button.setMaximumSize(QtCore.QSize(button_size, button_size))
        self.set_zero_to_avg_button.setText("")
        self.set_zero_to_avg_button.setCheckable(True)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.set_zero_to_avg_button.setIcon(icon)
        self.set_zero_to_avg_button.setIconSize(QtCore.QSize(button_size, button_size))
        self.grid_layout3.addWidget(self.set_zero_to_avg_button, 0, 2, 1, 1)

        self.filter_curve_button = QtWidgets.QPushButton(self.centralwidget)
        self.filter_curve_button.setObjectName("Filter")
        self.filter_curve_button.setMinimumSize(QtCore.QSize(button_size, button_size))
        self.filter_curve_button.setMaximumSize(QtCore.QSize(button_size, button_size))
        self.filter_curve_button.setText("")
        self.filter_curve_button.setCheckable(True)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.filter_curve_button.setIcon(icon)
        self.filter_curve_button.setIconSize(QtCore.QSize(button_size, button_size))
        self.grid_layout3.addWidget(self.filter_curve_button, 0, 3, 1, 1)

        self.fit_line_button = QtWidgets.QPushButton(self.centralwidget)
        self.fit_line_button.setObjectName("Fit_line_button")
        self.fit_line_button.setMinimumSize(QtCore.QSize(button_size, button_size))
        self.fit_line_button.setMaximumSize(QtCore.QSize(button_size, button_size))
        self.fit_line_button.setText("")
        self.fit_line_button.setCheckable(True)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fit_line_button.setIcon(icon)
        self.fit_line_button.setIconSize(QtCore.QSize(button_size, button_size))
        self.grid_layout3.addWidget(self.fit_line_button, 0, 4, 1, 1)

        self.fourier_curve_button = QtWidgets.QPushButton(self.centralwidget)
        self.fourier_curve_button.setObjectName("Fourier_curve_button")
        self.fourier_curve_button.setMinimumSize(QtCore.QSize(button_size, button_size))
        self.fourier_curve_button.setMaximumSize(QtCore.QSize(button_size, button_size))
        self.fourier_curve_button.setText("")
        self.fourier_curve_button.setCheckable(True)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resources_path("")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fourier_curve_button.setIcon(icon)
        self.fourier_curve_button.setIconSize(QtCore.QSize(button_size, button_size))
        self.grid_layout3.addWidget(self.fourier_curve_button, 0, 5, 1, 1)

        # Spectroscopy tools
        self.label4 = QtWidgets.QLabel(self.centralwidget, text='Spectroscopy')
    ...
    def _update_push_buttons(self):
        if self.active_result_window == None:
            ...
            if active_window.winState.undo_possible():
                self.undo_button.setDisabled(False)
            else:
                self.undo_button.setDisabled(True)
            if active_window.winState.redo_possible():
